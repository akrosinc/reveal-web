...
import { faChevronRight, faChevronDown, faEllipsisV, faCheck } from '@fortawesome/free-solid-svg-icons';
            ...
            {!hasChildren ? (
              <>
                ...
                <label
                  ...
                  style={{ cursor: readOnly ? 'default' : 'pointer', userSelect: 'none', color: isDarkMode ? '#fff' : '#000' }}
                >
