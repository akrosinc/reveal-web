...
export const IRS_STRUCTURE_COLOR_COMPLETE = '#A7171A';
export const IRS_STRUCTURE_COLOR_NOT_VISITED = '#5DBB63';
export const IRS_STRUCTURE_COLOR_NOT_ELIGIBLE = '#656565';
export const IRS_STRUCTURE_COLOR_SMC_COMPLETE = '#6e599f';
export const IRS_STRUCTURE_COLOR_SPAQ_COMPLETE = '#ffc107';
...
export const MAP_IRS_STRUCTURE_LEGEND_COLORS = [
  IRS_STRUCTURE_COLOR_COMPLETE,
  IRS_STRUCTURE_COLOR_NOT_VISITED,
  IRS_STRUCTURE_COLOR_NOT_ELIGIBLE,
  IRS_STRUCTURE_COLOR_SMC_COMPLETE,
  IRS_STRUCTURE_COLOR_SPAQ_COMPLETE
];
