...
describe('PlanAssignment/withTreeWalker', () => {
  ...
  it('TreeWalker works when no tree is given', async () => {
    ...
    expect(fetch.mock.calls).toEqual([
      [
        'https://opensrp-ops.akros.online/opensrp/rest/location/dfb858b5-b3e5-4871-9d1c-ae2f3fa83b63?is_jurisdiction=true&return_geometry=false',
        partOfResult,
      ],
      [
        'https://opensrp-ops.akros.online/opensrp/rest/location/findByProperties?is_jurisdiction=true&return_geometry=false&properties_filter=status:Active,parentId:dfb858b5-b3e5-4871-9d1c-ae2f3fa83b63',
        partOfResult,
      ],
      [
    ...
    expect(fetch.mock.calls[4]).toEqual([
      'https://opensrp-ops.akros.online/opensrp/rest/location/findByProperties?is_jurisdiction=true&return_geometry=false&properties_filter=status:Active,parentId:8d44d54e-8b4c-465c-9e93-364a25739a6d',
      partOfResult,
    ]);
